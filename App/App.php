...
//smpleader20180811 No HttpFoundation
//use Symfony\Component\HttpFoundation\Session\Session;
use Joomla\Session\Session;
use Joomla\Event\Dispatcher;
use App\Listener\ContentListener;
...
final class App extends AbstractWebApplication implements ContainerAwareInterface
{
	...
	public function __construct(Container $container)
	{
		...
		// smpleader20181108 placeholder for dispatcher
		$this->dispatcher = new Dispatcher;
		$this->dispatcher->addListener(new ContentListener);
	}
	...
	{
		$this->getSession()->set($type, $msg); //->getFlashBag()
	...
	public function getSession()
	{
		if (is_null($this->newSession))
		{
			...
			$this->newSession->initialise($this->input, $this->dispatcher);
	...
	public function clearMessageQueue()
	{
		...
		$this->getSession()->set('error','') ;
		$this->getSession()->set('warning','') ;
		//getFlashBag()->clear();
	}
	...
	{
		return $this->getSession()->get('message','') ;//->getFlashBag()->peekAll();
	}
	 ...
	 * @since   1.0
	 */
	public function setMessageQueue($type, $message = 'message')
	{
		$this->getSession()->set($type, $message); //->getFlashBag()
	}
}
